...
public final class InventoryWorkaround {
    ...
    /*
     * Spigot 1.9, for whatever reason, decided to merge the armor and main
     * player inventories without providing a way to access the main inventory.
     * There's lots of ugly code in here to work around that.
     */
    ...
    public static Map<Integer, ItemStack> addOversizedItems(final Inventory inventory, final int oversizedStacks,
    ...
    public static void setItemInOffHand(Player p, ItemStack item) {
        // This assumes that all builds that support a main hand also support an
        // off hand.
