	...
	public String serialize(ItemStack is) {
		...
		case ENCHANTED_BOOK:
			...
			for (Enchantment e : enchantmentStorageMeta.getStoredEnchants().keySet()) {
				sb.append(e.getName().toLowerCase()).append(":").append(enchantmentStorageMeta.getStoredEnchantLevel(e))
						.append(" ");
			}
			break;
		case FIREWORK:
		...
		case POTION:
			...
			for (PotionEffect e : potion.getEffects()) {
				...
				sb.append("splash:").append(potion.isSplash()).append(" ").append("effect:")
						.append(e.getType().getName().toLowerCase()).append(" ").append("power:")
						.append(e.getAmplifier()).append(" ").append("duration:").append(e.getDuration() / 20)
						.append(" ");
			}
			break;
		case SKULL_ITEM:
		...
		case BANNER:
			...
			break;
		case SHIELD:
			// Hacky fix for accessing Shield meta -
			// https://github.com/drtshock/Essentials/pull/745#issuecomment-234843795
